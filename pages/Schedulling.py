...
#CO_R = 0.8
#MUT_R = 0.2
CO_R = st.input('Crossover Rate', min_value=0.0, max_value=0.95, value=0.8, step=0.01)
MUT_R = st.input('Mutation Rate', min_value=0.01, max_value=0.05, value=0.02, step=0.01)
EL_S = 2
