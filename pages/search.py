...
for i in range(1, 12):  # Updated to allow 11 cities
    st.write("City")
    city_name = st.text_input("CityName")
    x_coord = st.number_input("x-coordinate", min_value=1.0, max_value=10.0, step=0.1)
    y_coord = st.number_input("y-coordinate", min_value=1.0, max_value=10.0, step=0.1,)
